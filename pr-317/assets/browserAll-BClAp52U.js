import { a4 as M, a5 as Z, a6 as m, a7 as te, P as y, E as ie, y as g, a3 as P, C as V } from "./index-AQ5Lyh40.js";
import "./webworkerAll-CYnM9rDK.js";
...
var I = /iPhone/i, B = /iPod/i, C = /iPad/i, U = /\biOS-universal(?:.+)Mac\b/i, k = /\bAndroid(?:.+)Mobile\b/i, R = /Android/i, b = /(?:SD4930UR|\bSilk(?:.+)Mobile\b)/i, O = /Silk/i, v = /Windows Phone/i, X = /\bWindows(?:.+)ARM\b/i, K = /BlackBerry/i, Y = /BB10/i, H = /Opera Mini/i, F = /\b(CriOS|Chrome)(?:.+)Mobile/i, N = /Mobile(?:.+)Firefox\b/i, $ = function(a) {
...
function G(a) {
  ...
  var n = ne(t), s = { apple: { phone: n(I) && !n(v), ipod: n(B), tablet: !n(I) && (n(C) || $(e)) && !n(v), universal: n(U), device: (n(I) || n(B) || n(C) || n(U) || $(e)) && !n(v) }, amazon: { phone: n(b), tablet: !n(b) && n(O), device: n(b) || n(O) }, android: { phone: !n(v) && n(b) || !n(v) && n(k), tablet: !n(v) && !n(b) && !n(k) && (n(O) || n(R)), device: !n(v) && (n(b) || n(O) || n(k) || n(R)) || n(/\bokhttp\b/i) }, windows: { phone: n(v), tablet: n(X), device: n(v) || n(X) }, other: { blackberry: n(K), blackberry10: n(Y), opera: n(H), firefox: n(N), chrome: n(F), device: n(K) || n(Y) || n(H) || n(N) || n(F) }, any: false, phone: false, tablet: false };
