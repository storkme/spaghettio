import { ak as ze, af as ie, O as m, G as Ve, f as Ne, e as je, al as oe, P as l, a3 as W, am as w, an as $e, ao as z, ap as T, a2 as V, aq as le, ar as qe, h as f, D as g, ad as I, as as de, y as ue, at as Z, au as ce, av as he, aw as pe, ax as fe, C as P, j as Ke, n as E, a0 as N, R as B, ay as Ye, az as Je, a6 as Xe, aA as Qe, ab as Ze, a4 as ee, aB as te, g as p, K as et, ae as R, $ as O, aC as tt, v as rt, aD as st, aE as nt } from "./index-giPHNpfY.js";
import { F as at } from "./Filter-DpNKlQi5.js";
...
class be {
  ...
  execute(e) {
    ...
    e.action === "pushMaskBegin" ? (s.renderTarget.ensureDepthStencil(), s.stencil.setStencilMode(g.RENDERING_MASK_ADD, i), i++, s.colorMask.setMask(0)) : e.action === "pushMaskEnd" ? (e.inverse ? s.stencil.setStencilMode(g.INVERSE_MASK_ACTIVE, i) : s.stencil.setStencilMode(g.MASK_ACTIVE, i), s.colorMask.setMask(15)) : e.action === "popMaskBegin" ? (s.colorMask.setMask(0), i !== 0 ? s.stencil.setStencilMode(g.RENDERING_MASK_REMOVE, i) : (s.renderTarget.clear(null, I.STENCIL), s.stencil.setStencilMode(g.DISABLED, i)), i--) : e.action === "popMaskEnd" && (e.inverse ? s.stencil.setStencilMode(g.INVERSE_MASK_ACTIVE, i) : s.stencil.setStencilMode(g.MASK_ACTIVE, i), s.colorMask.setMask(15)), this._maskStackHash[n] = i;
  }
  destroy() {
...
let mt = $;
const D = { png: "image/png", jpg: "image/jpeg", webp: "image/webp" }, q = class we {
  constructor(e) {
    this._renderer = e;
  }
  ...
  async base64(e) {
    ...
    if (s.toDataURL !== void 0) return s.toDataURL(D[t], r);
    if (s.convertToBlob !== void 0) {
      const n = await s.convertToBlob({ type: D[t], quality: r });
...
class Pe {
  ...
  generateTexture(e) {
    ...
    const o = Je.create({ ...e.textureSourceOptions, width: i.width, height: i.height, resolution: t, antialias: r }), d = m.shared.translate(-i.x, -i.y);
...
const K = class Be {
  ...
  init(e) {
    e = { ...Be.defaultOptions, ...e }, this.maxUnusedTime = e.gcMaxUnusedTime, this._frequency = e.gcFrequency, this.enabled = e.gcActive, this.now = performance.now();
  }
  get enabled() {
...
Ge.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "globalUniforms" };
let Ct = 1;
class Ue {
  constructor() {
...
J.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "renderableGC", priority: 0 };
J.defaultOptions = { renderableGCActive: true, renderableGCMaxUnusedTime: 6e4, renderableGCFrequency: 3e4 };
let Mt = J;
const X = class S {
  get count() {
...
X.extension = { type: [l.WebGLSystem, l.WebGPUSystem], name: "textureGC" };
X.defaultOptions = { textureGCActive: true, textureGCAMaxIdle: null, textureGCMaxIdle: 3600, textureGCCheckCountMax: 600 };
let Rt = X;
const De = class Ie {
  constructor(e = {}) {
    if (this.uid = et("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = false, this._size = new Float32Array(2), this._managedColorTextures = false, e = { ...Ie.defaultOptions, ...e }, this.stencil = e.stencil, this.depth = e.depth, this.isRoot = e.isRoot, typeof e.colorTextures == "number") {
...
const Q = class Oe {
  ...
  init(e) {
    e = { ...Oe.defaultOptions, ...e }, e.view && (p(rt, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new B(0, 0, e.width, e.height), this.canvas = e.canvas || N.get().createCanvas(), this.antialias = !!e.antialias, this.texture = Ee(this.canvas, e), this.renderTarget = new H({ colorTextures: [this.texture], depth: !!e.depth, isRoot: true }), this.texture.source.transparent = e.backgroundAlpha < 1, this.resolution = e.resolution;
  }
  resize(e, t, r) {
...
let St = Q;
const Ut = [mt, Ge, Y, St, Re, yt, Rt, Pe, gt, st, Mt, Ue], At = [Ce, ge, ye, ve, _e, be, xe, Te];
