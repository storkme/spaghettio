...
Copy this file to `docs/rfc-<short-name>.md` for any non-trivial design
work. The goal of an RFC is **shared understanding before code** and
...
**Required.** Explicit, observable conditions under which this RFC
...
If you can't write a kill criterion you'd actually act on, the RFC
...
Append entries here as the RFC progresses. Date them.
