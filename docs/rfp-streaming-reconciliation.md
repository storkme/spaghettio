# RFP: streaming renderer reconciles to `layout.entities` at finish
...
state) is the motivating failure. After this RFP, `layout.entities` is
...
The shape of the bug is what this RFP targets: **the streaming
...
coherent and shouldn't be split. Writing the RFP, refactoring
