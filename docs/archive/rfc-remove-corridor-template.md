# RFC: Remove the corridor template
...
`models.rs`. The RFC is predominantly *subtractive*.
...
unified-belt-specs RFC but doesn't address the greedy-ordering
...
This RFC is a single-phase deletion. No Phase 0 audit needed — the
...
- **[`rfc-unified-belt-specs.md`](rfc-unified-belt-specs.md)** —
  ...
  work but are independent of this RFC. The capped fixture becomes
...
- *2026-04-21 — RFC drafted after the unified-belt-specs Phase 1
