...
| 4 | `advanced-circuit` | 5+ recipes, mixed solid/fluid | SOLVED — from plates fully clean; from ore (AM2) **fully clean since RFC-059** (the horizontal-stack candidate wins strictly-better and deletes the long-standing input-rate-delivery residual). Partitioned 4/s + 5/s and horizontal-stack 7/s stress-gated. |
