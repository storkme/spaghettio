...
merger defect stands — **but #311's stamp-based evidence was falsified
2026-08-07** (`rate-stamp-semantics.md`); the cap awaits re-evidencing, not a
fix (parked → cluster
