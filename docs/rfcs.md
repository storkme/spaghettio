...
| RFC-059 | 2026-07-30 | [`rfc-059-horizontal-stack-candidate.md`](rfc-059-horizontal-stack-candidate.md) | Active — HorizontalStack as default-on scored candidate (never-worse contract, mirrors DI). Evidence #513; sim on flipped cases gates the merge (K59-3) |
