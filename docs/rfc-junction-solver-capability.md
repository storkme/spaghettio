# RFC: Junction-solver capability
...
infeasibility, it's solver capacity. This RFC proposes a phased
...
`rfc-modular-production` and any future bus topology that creates
...
These are cumulative — if any trigger, the RFC either pivots or
shuts down.
