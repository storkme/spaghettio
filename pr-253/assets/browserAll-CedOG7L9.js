import { Y as M, Z, _ as m, $ as te, F as y, E as ie, w as g, X as P, a0 as V } from "./index-DP6X1sse.js";
import "./webworkerAll-D5OrqiyG.js";
...
var I = /iPhone/i, B = /iPod/i, C = /iPad/i, U = /\biOS-universal(?:.+)Mac\b/i, k = /\bAndroid(?:.+)Mobile\b/i, R = /Android/i, b = /(?:SD4930UR|\bSilk(?:.+)Mobile\b)/i, O = /Silk/i, v = /Windows Phone/i, X = /\bWindows(?:.+)ARM\b/i, K = /BlackBerry/i, Y = /BB10/i, H = /Opera Mini/i, F = /\b(CriOS|Chrome)(?:.+)Mobile/i, $ = /Mobile(?:.+)Firefox\b/i, N = function(a) {
...
function G(a) {
  ...
  var n = ne(t), s = { apple: { phone: n(I) && !n(v), ipod: n(B), tablet: !n(I) && (n(C) || N(e)) && !n(v), universal: n(U), device: (n(I) || n(B) || n(C) || n(U) || N(e)) && !n(v) }, amazon: { phone: n(b), tablet: !n(b) && n(O), device: n(b) || n(O) }, android: { phone: !n(v) && n(b) || !n(v) && n(k), tablet: !n(v) && !n(b) && !n(k) && (n(O) || n(R)), device: !n(v) && (n(b) || n(O) || n(k) || n(R)) || n(/\bokhttp\b/i) }, windows: { phone: n(v), tablet: n(X), device: n(v) || n(X) }, other: { blackberry: n(K), blackberry10: n(Y), opera: n(H), firefox: n($), chrome: n(F), device: n(K) || n(Y) || n(H) || n($) || n(F) }, any: false, phone: false, tablet: false };
...
L.extension = { type: [y.WebGLSystem, y.WebGPUSystem], name: "accessibility" };
L.defaultOptions = { enabledByDefault: false, debug: false, activateOnTab: true, deactivateOnMouseMove: true };
let ue = L;
...
class _e {
  constructor(e) {
    this.dispatch = new ie(), this.moveOnAll = false, this.enableGlobalMoveEvents = true, this.mappingState = { trackingData: {} }, this.eventPool = /* @__PURE__ */ new Map(), this._allInteractiveElements = [], this._hitElements = [], this._isPointerMoveEvent = false, this.rootTarget = e, this.hitPruneFn = this.hitPruneFn.bind(this), this.hitTestFn = this.hitTestFn.bind(this), this.mapPointerDown = this.mapPointerDown.bind(this), this.mapPointerMove = this.mapPointerMove.bind(this), this.mapPointerOut = this.mapPointerOut.bind(this), this.mapPointerOver = this.mapPointerOver.bind(this), this.mapPointerUp = this.mapPointerUp.bind(this), this.mapPointerUpOutside = this.mapPointerUpOutside.bind(this), this.mapWheel = this.mapWheel.bind(this), this.mappingTable = {}, this.addEventMapping("pointerdown", this.mapPointerDown), this.addEventMapping("pointermove", this.mapPointerMove), this.addEventMapping("pointerout", this.mapPointerOut), this.addEventMapping("pointerleave", this.mapPointerOut), this.addEventMapping("pointerover", this.mapPointerOver), this.addEventMapping("pointerup", this.mapPointerUp), this.addEventMapping("pointerupoutside", this.mapPointerUpOutside), this.addEventMapping("wheel", this.mapWheel);
  }
  addEventMapping(e, t) {
...
const ge = 1, ye = { touchstart: "pointerdown", touchend: "pointerup", touchendoutside: "pointerupoutside", touchmove: "pointermove", touchcancel: "pointercancel" }, S = class x {
  constructor(e) {
    this.supportsTouchEvents = "ontouchstart" in globalThis, this.supportsPointerEvents = !!globalThis.PointerEvent, this.domElement = null, this.resolution = 1, this.renderer = e, this.rootBoundary = new _e(null), f.init(this), this.autoPreventDefault = true, this._eventsAdded = false, this._rootPointerEvent = new u(null), this._rootWheelEvent = new E(null), this.cursorStyles = { default: "inherit", pointer: "pointer" }, this.features = new Proxy({ ...x.defaultEventFeatures }, { set: (t, i, n) => (i === "globalMove" && (this.rootBoundary.enableGlobalMoveEvents = n), t[i] = n, true) }), this._onPointerDown = this._onPointerDown.bind(this), this._onPointerMove = this._onPointerMove.bind(this), this._onPointerUp = this._onPointerUp.bind(this), this._onPointerOverOut = this._onPointerOverOut.bind(this), this.onWheel = this.onWheel.bind(this);
  }
  ...
  _normalizeToPointerData(e) {
    ...
    if (this.supportsTouchEvents && e instanceof TouchEvent) for (let i = 0, n = e.changedTouches.length; i < n; i++) {
      ...
      typeof s.button > "u" && (s.button = 0), typeof s.buttons > "u" && (s.buttons = 1), typeof s.isPrimary > "u" && (s.isPrimary = e.touches.length === 1 && e.type === "touchstart"), typeof s.width > "u" && (s.width = s.radiusX || 1), typeof s.height > "u" && (s.height = s.radiusY || 1), typeof s.tiltX > "u" && (s.tiltX = 0), typeof s.tiltY > "u" && (s.tiltY = 0), typeof s.pointerType > "u" && (s.pointerType = "touch"), typeof s.pointerId > "u" && (s.pointerId = s.identifier || 0), typeof s.pressure > "u" && (s.pressure = s.force || 0.5), typeof s.twist > "u" && (s.twist = 0), typeof s.tangentialPressure > "u" && (s.tangentialPressure = 0), typeof s.layerX > "u" && (s.layerX = s.offsetX = s.clientX), typeof s.layerY > "u" && (s.layerY = s.offsetY = s.clientY), s.isNormalized = true, s.type = e.type, s.altKey ?? (s.altKey = e.altKey), s.ctrlKey ?? (s.ctrlKey = e.ctrlKey), s.metaKey ?? (s.metaKey = e.metaKey), s.shiftKey ?? (s.shiftKey = e.shiftKey), t.push(s);
    }
...
S.extension = { name: "events", type: [y.WebGLSystem, y.CanvasSystem, y.WebGPUSystem], priority: -1 };
S.defaultEventFeatures = { move: true, globalMove: true, click: true, wheel: true };
let ee = S;
