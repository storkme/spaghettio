...
pub fn compose_mega_calibrated(
    ...
    let opts = crate::bus::layout::LayoutOptions {
        ...
        // RFC-069 Phase 3: cell-scoped duty 1.0, same rationale as
        ...
        // #415 stop-gap: mega interiors do not yet thread inserter
        // capacity, so pin L0 here regardless of the engine default
        // (which moved to L2 in 2026-07-24's #383 change). Without this
        // the mega geometry would silently follow the default and drift
...
pub fn compose_mega_block(
    ...
    let opts = crate::bus::layout::LayoutOptions {
        ...
        // #415 stop-gap: pin mega interiors to L0 regardless of the
