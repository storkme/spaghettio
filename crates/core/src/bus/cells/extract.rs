...
pub fn generate_cell_layout_with_capacity(
    ...
    // Cells are generated by the BUS pipeline by definition — force the
    // composition flag Off here or a Candidate default recurses
    ...
    let opts = layout::LayoutOptions {
        ...
        // RFC-059: cell geometry must be candidate-independent —
