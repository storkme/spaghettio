import { ad as ze, a8 as ie, M as m, G as Ve, b as Ne, a as je, ae as oe, F as l, X as W, af as w, ag as $e, ah as z, ai as T, W as V, aj as le, ak as qe, T as f, t as g, a6 as D, al as de, w as ue, am as Z, an as ce, ao as he, ap as pe, aq as fe, a0 as P, c as Ke, h as E, U as N, R as G, ar as Ye, as as Xe, _ as Je, at as Qe, a4 as Ze, Y as ee, au as te, d as p, y as et, a7 as R, Q as O, av as tt, v as rt, aw as st, ax as nt } from "./index-BPW0efmb.js";
import { F as at } from "./Filter-B1TI5Nwq.js";
...
class lt extends at {
  constructor(e) {
    const { sprite: t, ...r } = e, s = new ze(t.texture), n = new ie({ uFilterMatrix: { value: new m(), type: "mat3x3<f32>" }, uMaskClamp: { value: s.uClampFrame, type: "vec4<f32>" }, uAlpha: { value: 1, type: "f32" }, uInverse: { value: e.inverse ? 1 : 0, type: "f32" } }), i = Ve.from({ vertex: { source: re, entryPoint: "mainVertex" }, fragment: { source: re, entryPoint: "mainFragment" } }), o = Ne.from({ vertex: ot, fragment: it, name: "mask-filter" });
...
const j = class me {
  constructor(e, t) {
    var _a, _b;
    this.state = je.for2d(), this._batchersByInstructionSet = /* @__PURE__ */ Object.create(null), this._activeBatches = /* @__PURE__ */ Object.create(null), this.renderer = e, this._adaptor = t, (_b = (_a = this._adaptor).init) == null ? void 0 : _b.call(_a, this);
  }
  static getBatcher(e) {
  ...
  buildStart(e) {
    ...
    t || (t = this._batchersByInstructionSet[e.uid] = /* @__PURE__ */ Object.create(null), t.default || (t.default = new oe({ maxTextures: this.renderer.limits.maxBatchableTextures }))), this._activeBatches = t, this._activeBatch = this._activeBatches.default;
...
class ut extends le {
  constructor() {
    super(), this.filters = [new lt({ sprite: new qe(f.EMPTY), inverse: false, resolution: "inherit", antialias: "inherit" })];
  }
  get sprite() {
...
_e.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "alphaMask" };
class xe {
  constructor(e) {
...
xe.extension = { type: [l.WebGLPipes, l.WebGPUPipes], name: "colorMask" };
class be {
  constructor(e) {
...
be.extension = { type: [l.WebGLPipes, l.WebGPUPipes], name: "stencilMask" };
class Te {
  constructor(e) {
    this._renderer = e;
  }
...
Te.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "customRender" };
function L(a, e) {
...
class ve {
  ...
  _addRenderableCacheAsTexture(e, t) {
    const r = e._batchableRenderGroup ?? (e._batchableRenderGroup = w.get(de));
...
ye.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "sprite" };
const v = {};
...
class Ce {
  ...
  _beginAdvancedBlendMode(e, t) {
    ...
    const s = this._ensureFilterEffect(r), n = e instanceof Z, i = { renderPipeId: "filter", action: "pushFilter", filterEffect: s, renderables: n ? null : [e], container: n ? e.root : null, canBundle: false };
    this._renderableList = i.renderables, t.add(i);
  }
  _ensureFilterEffect(e) {
    let t = this._filterHash[e];
    return t || (t = this._filterHash[e] = new le(), t.filters = [new v[e]()]), t;
  }
...
Ce.extension = { type: [l.WebGLPipes, l.WebGPUPipes, l.CanvasPipes], name: "blendMode" };
function F(a, e) {
  e || (e = 0);
  for (let t = e; t < a.length && a[t]; t++) a[t] = null;
}
const ct = new P(), se = he | pe | fe;
function ke(a, e = false) {
  ht(a);
  ...
  if (e) for (let s = 0; s < a.renderGroupChildren.length; s++) ke(a.renderGroupChildren[s], e);
}
function ht(a) {
  const e = a.root;
  let t;
...
let mt = $;
const I = { png: "image/png", jpg: "image/jpeg", webp: "image/webp" }, q = class we {
  constructor(e) {
    this._renderer = e;
  }
...
let gt = q;
const _t = new G(), xt = new z(), bt = [0, 0, 0, 0];
class Pe {
  constructor(e) {
    this._renderer = e;
  }
  generateTexture(e) {
    ...
    const i = ((_a = e.frame) == null ? void 0 : _a.copyTo(_t)) || Ye(s, xt).rectangle;
    i.width = Math.max(i.width, 1 / t) | 0, i.height = Math.max(i.height, 1 / t) | 0;
    const o = Xe.create({ ...e.textureSourceOptions, width: i.width, height: i.height, resolution: t, antialias: r }), d = m.shared.translate(-i.x, -i.y);
...
Pe.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "textureGenerator" };
function Tt(a) {
  let e = false;
...
K.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "gc", priority: 0 };
K.defaultOptions = { gcActive: true, gcMaxUnusedTime: 6e4, gcFrequency: 3e4 };
let yt = K;
class Be {
  constructor(e) {
  ...
  _createUniforms() {
    return new ie({ uProjectionMatrix: { value: new m(), type: "mat3x3<f32>" }, uWorldTransformMatrix: { value: new m(), type: "mat3x3<f32>" }, uWorldColorAlpha: { value: new Float32Array(4), type: "vec4<f32>" }, uResolution: { value: [0, 0], type: "vec2<f32>" } }, { isStatic: true });
  }
  destroy() {
...
Be.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "globalUniforms" };
let Ct = 1;
class Ue {
  constructor() {
...
Ue.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "scheduler", priority: 0 };
let ae = false;
function kt(a) {
  if (!ae) {
    if (N.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1) {
      const e = [`%c  %c  %c  %c  %c PixiJS %c v${te} (${a}) http://www.pixijs.com/
...
`, "background: #E72264; padding:5px 0;", "background: #6CA2EA; padding:5px 0;", "background: #B5D33D; padding:5px 0;", "background: #FED23F; padding:5px 0;", "color: #FFFFFF; background: #E72264; padding:5px 0;", "color: #E72264; background: #FFFFFF; padding:5px 0;"];
    ...
    } else globalThis.console && globalThis.console.log(`PixiJS ${te} - ${a} - http://www.pixijs.com/`);
    ae = true;
  }
}
class Y {
...
Y.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "hello", priority: -2 };
Y.defaultOptions = { hello: false };
const X = class Ae {
  constructor(e) {
    this._renderer = e;
  }
  init(e) {
    e = { ...Ae.defaultOptions, ...e }, this.maxUnusedTime = e.renderableGCMaxUnusedTime;
  }
  get enabled() {
...
J.extension = { type: [l.WebGLSystem, l.WebGPUSystem], name: "textureGC" };
J.defaultOptions = { textureGCActive: true, textureGCAMaxIdle: null, textureGCMaxIdle: 3600, textureGCCheckCountMax: 600 };
let Rt = J;
const Ie = class De {
  constructor(e = {}) {
    if (this.uid = et("renderTarget"), this.colorTextures = [], this.dirtyId = 0, this.isRoot = false, this._size = new Float32Array(2), this._managedColorTextures = false, e = { ...De.defaultOptions, ...e }, this.stencil = e.stencil, this.depth = e.depth, this.isRoot = e.isRoot, typeof e.colorTextures == "number") {
      this._managedColorTextures = true;
      for (let t = 0; t < e.colorTextures; t++) this.colorTextures.push(new R({ width: e.width, height: e.height, resolution: e.resolution, antialias: e.antialias }));
    } else {
    ...
    this.colorTexture.source.on("resize", this.onSourceResize, this), (e.depthStencilTexture || this.stencil) && (e.depthStencilTexture instanceof f || e.depthStencilTexture instanceof R ? this.depthStencilTexture = e.depthStencilTexture.source : this.ensureDepthStencilTexture());
  }
  get size() {
    const e = this._size;
  ...
  ensureDepthStencilTexture() {
    this.depthStencilTexture || (this.depthStencilTexture = new R({ width: this.width, height: this.height, resolution: this.resolution, format: "depth24plus-stencil8", autoGenerateMipmaps: false, antialias: false, mipLevelCount: 1 }));
  }
...
Ie.defaultOptions = { width: 0, height: 0, resolution: 1, colorTextures: 1, stencil: false, depth: false, antialias: false, isRoot: false };
let H = Ie;
...
const Q = class Oe {
  ...
  init(e) {
    e = { ...Oe.defaultOptions, ...e }, e.view && (p(rt, "ViewSystem.view has been renamed to ViewSystem.canvas"), e.canvas = e.view), this.screen = new G(0, 0, e.width, e.height), this.canvas = e.canvas || N.get().createCanvas(), this.antialias = !!e.antialias, this.texture = Ee(this.canvas, e), this.renderTarget = new H({ colorTextures: [this.texture], depth: !!e.depth, isRoot: true }), this.texture.source.transparent = e.backgroundAlpha < 1, this.resolution = e.resolution;
  }
  resize(e, t, r) {
...
Q.extension = { type: [l.WebGLSystem, l.WebGPUSystem, l.CanvasSystem], name: "view", priority: 0 };
Q.defaultOptions = { width: 800, height: 600, autoDensity: false, antialias: false };
let St = Q;
const Ut = [mt, Be, Y, St, Re, yt, Rt, Pe, gt, st, Mt, Ue], At = [Ce, ge, ye, ve, _e, be, xe, Te];
...
class It {
  ...
  bind(e, t = true, r, s, n = 0, i = 0) {
    ...
    const _ = Math.max(u.pixelWidth >> n, 1), B = Math.max(u.pixelHeight >> n, 1);
    if (!s && e instanceof f && (s = e.frame), s) {
      const y = u._resolution, C = 1 << Math.max(n | 0, 0), Le = s.x * y + 0.5 | 0, Fe = s.y * y + 0.5 | 0, He = s.width * y + 0.5 | 0, We = s.height * y + 0.5 | 0;
      let k = Math.floor(Le / C), M = Math.floor(Fe / C), U = Math.ceil(He / C), A = Math.ceil(We / C);
      k = Math.min(Math.max(k, 0), _ - 1), M = Math.min(Math.max(M, 0), B - 1), U = Math.min(Math.max(U, 1), _ - k), A = Math.min(Math.max(A, 1), B - M), h.x = k, h.y = M, h.width = U, h.height = A;
    } else h.x = 0, h.y = 0, h.width = _, h.height = B;
  ...
  _initRenderTarget(e) {
    let t = null;
    return O.test(e) && (e = Ee(e).source), e instanceof H ? t = e : e instanceof R && (t = new H({ colorTextures: [e] }), e.source instanceof O && (t.isRoot = true), e.once("destroy", () => {
